...
import { uploadedImg } from '../Actions'
class UploadImage extends Component {
    ...
    takeAphoto = async () => {
        ...
        uploadResponse = this.uploadImageAsync(localUri).then((reponse) => {
           
            this.setState({
                loading: false,
                uploaded_photo: localUri
            })
        });
    ...
    async uploadImageAsync(uri) {
        ...
        this.props.uploadedImg(formData);
        return formData;
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({ uploadedImg }, dispatch);
}
